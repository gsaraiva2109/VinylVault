...
export default function Card({ title, image, category, author, time, link = '#' }: Props) {
  return (
    <article className={styles.card}>
      <div className={styles.cardInfoHover}>
        <svg className={styles.cardLike} viewBox="0 0 24 24">
          <path
            fill="#000000"
      ...
      <a href={link} className={styles.cardLink}>
        <div className={styles.cardImgHover} style={{ backgroundImage: `url(${image})` }} />
      </a>
